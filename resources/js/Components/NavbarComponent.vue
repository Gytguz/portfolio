...
<nav class="bg-stone-200 shadow">
  <div class="container mx-auto px-6 py-3 md:flex md:justify-between md:items-center">
    <div class="flex justify-between items-center">
      <div>
        <gray-button-component as="href" href="#" class="">
          E-Shop
      ...
      <div class="flex md:hidden">
        <button type="button" class="text-gray-500 hover:text-stone-600 focus:outline-none focus:text-gray-600" aria-label="toggle menu">
    ...
    <div class="md:flex items-center">
      ...
      <div class="flex justify-center md:block">
        <a class="relative text-gray-700 hover:text-gray-600 hover:text-indigo-500" href="#">
...
import GrayButtonComponent from './Buttons/GrayButtonComponent.vue';
